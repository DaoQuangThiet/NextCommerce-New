...
export const getUpdatedProducts = (existingProductsInCart, product, qtyToBeAdded, newQty = false) => {
    ...
    if (-1 < productExitsIndex) {
        ...
        updatedProduct.qty = (newQty) ? parseInt(newQty) : parseInt(updateProduct.qty + qtyToBeAdded);
        //update proce on cart
        updatedProduct.totalPrice = parseFloat((updateProduct.price * updateProduct.qty).toFixed(2));
